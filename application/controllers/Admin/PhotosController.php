...
class Admin_PhotosController extends Zend_Controller_Action
{
    ...
    public function addAction() {
        ...
        if ($request->isPost() && $request->getPost('task') === 'save') {
            ...
            try {
                ...
                // remove key photo_upload from data because there is no column 'photo_upload' in cms_photos table
                ...
                if($form->getElement('photo_upload')->isUploaded()){
                    ...
                    try{
                        ...
                        $flashMessenger->addMessage('Photo has been saved, but error ocured during image processing', 'errors');
    ...
    public function editAction() {
        ...
        if ($request->isPost() && $request->getPost('task') === 'update') {
            ...
            try {
                ...
                $cmsPhotosTable->updatePhotoById($photo['id'], $formData);
    ...
    public function deleteAction() {
        ...
        try{
            ...
            $cmsPhotosTable->deletePhoto($photo);

            
            // Brisanje slike za obrisanog photoa
            $photoFilePath = PUBLIC_PATH . '/uploads/photos/' . $photo['id'] . '.jpg';
    ...
    public function updateorderAction() {
        ...
        try{
            ...
            $cmsPhotosTable->updatePhotoOrder($sortedIds);
