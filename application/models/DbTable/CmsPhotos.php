...
class Application_Model_DbTable_CmsPhotos extends Zend_Db_Table_Abstract
{
    ...
    const STATUS_DISABLED = 0;
         ...
         * 
         * @param int $id
         * @param array $photo Associative array with keys as colom names and values as colom new values
         */
        ...
        /**
         * @param array $photo Associative array with keys as colom names and values as colom new values
         * @return int The ID of the new created photo (autoincrement)
         */
...
//            
//            $photo['order_number'] = $lastM['maxorder'] + 1;
        ...
        /**
         * 
         * @param array $photo Photo to delete
         */
         public function deletePhoto($photo){
            
            $this->update(array('order_number' => new Zend_Db_Expr('order_number -  1')), 'order_number > ' . $photo['order_number'] . ' AND photo_gallery_id = ' . $photo['photo_gallery_id']); 
             

            $this->delete('id=' . $photo['id']);
        }
        ...
        public function updatePhotoOrder($sortedIds) {
